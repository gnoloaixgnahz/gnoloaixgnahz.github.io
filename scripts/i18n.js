...
const translations = {
    en: {
        ...
        // Homepage
        'home.hero.title': 'Welcome to My Technology Journey',
        'home.hero.subtitle': 'Exploring AI, Data, and Robotics through shared thoughts, experiences, and knowledge',
        'home.hero.btn.ai': 'AI Infrastructure Book',
        'home.hero.btn.data': 'Data Lake & Big Data Book',
        'home.about.title': 'About This Site',
        'home.about.intro': 'This is my digital space for sharing knowledge, thoughts, and experiences in the fields of:',
        'home.about.ai.title': 'Artificial Intelligence',
        'home.about.ai.desc': 'Infrastructure, systems, and practical insights',
        'home.about.data.title': 'Data Engineering',
        'home.about.data.desc': 'Data lakes, big data architectures, and analytics',
        'home.about.robotics.title': 'Robotics',
        'home.about.robotics.desc': 'Systems, automation, and intelligent machines',
        'home.books.title': 'Featured Books',
        'home.books.ai.title': 'AI Infrastructure',
        'home.books.ai.desc': 'Comprehensive guide to building and managing AI infrastructure systems, covering everything from model deployment to scaling ML pipelines.',
        'home.books.ai.link': 'Read More →',
        'home.books.data.title': 'Data Lake & Big Data',
        'home.books.data.desc': 'Deep dive into modern data architectures, data lake design patterns, and big data processing frameworks.',
        'home.books.data.link': 'Read More →',
        'home.thoughts.title': 'Latest Thoughts',
        'home.thoughts.intro': 'Sharing insights, experiences, and reflections on technology',
        'home.thoughts.item.category': 'AI',
        'home.thoughts.item.date': 'Coming Soon',
        'home.thoughts.item.title': 'Thoughts and experiences will appear here',
        'home.thoughts.item.desc': 'This section will feature articles, insights, and reflections on AI, data engineering, and robotics.',
        'home.thoughts.item.link': 'Explore All Thoughts →',
    ...
    zh: {
        ...
        // Homepage
        'home.hero.title': '欢迎来到我的技术之旅',
        'home.hero.subtitle': '通过分享思想、经验和知识，探索人工智能、数据和机器人技术',
        'home.hero.btn.ai': 'AI 基础设施书籍',
        'home.hero.btn.data': '数据湖与大数据书籍',
        'home.about.title': '关于本站',
        'home.about.intro': '这是我的数字空间，用于分享以下领域的知识、思考和经验：',
        'home.about.ai.title': '人工智能',
        'home.about.ai.desc': '基础设施、系统和实用见解',
        'home.about.data.title': '数据工程',
        'home.about.data.desc': '数据湖、大数据架构和分析',
        'home.about.robotics.title': '机器人技术',
        'home.about.robotics.desc': '系统、自动化和智能机器',
        'home.books.title': '精选书籍',
        'home.books.ai.title': 'AI 基础设施',
        'home.books.ai.desc': '构建和管理 AI 基础设施系统的综合指南，涵盖从模型部署到扩展 ML 管道的所有内容。',
        'home.books.ai.link': '阅读更多 →',
        'home.books.data.title': '数据湖与大数据',
        'home.books.data.desc': '深入了解现代数据架构、数据湖设计模式和大数据处理框架。',
        'home.books.data.link': '阅读更多 →',
        'home.thoughts.title': '最新思考',
        'home.thoughts.intro': '分享对技术的见解、经验和反思',
        'home.thoughts.item.category': 'AI',
        'home.thoughts.item.date': '即将推出',
        'home.thoughts.item.title': '思考和经验将在此显示',
        'home.thoughts.item.desc': '此部分将展示关于 AI、数据工程和机器人技术的文章、见解和反思。',
        'home.thoughts.item.link': '探索所有思考 →',
